...
/* harmony import */ var bootstrap_js_dist_util__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! bootstrap/js/dist/util */ "./node_modules/bootstrap/js/dist/util.js");
...
var app = {
  ...
  plugins: {
    mask: function mask() {
      ...
      $('[data-mask="celphone"]').mask(SPMaskBehavior, spOptions); // $('[data-mask="telcelphone"]').mask(SPMaskBehavior, spOptions);

      $('.telcelphone').mask(SPMaskBehavior, spOptions);
    },
    slick: {
      avaliacoes: function avaliacoes() {
      ...
      antesDepois: function antesDepois() {
  ...
  functions: {
    ...
    modalPopupExit: function modalPopupExit() {
      // var showlead = false;
  ...
  init: function init() {
    ...
    $(document).ready(function () {
      ...
      app.functions.smoothAncora(); // if($('.video-imitacao .video-area .link').length){
...
/***/ 0:
/*!****************************************************************!*\
  !*** multi ./assets/src/js/app.js ./assets/src/scss/main.scss ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! C:\xampp\htdocs\ar-box\wp-content\themes\arbox\assets\src\js\app.js */"./assets/src/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\ar-box\wp-content\themes\arbox\assets\src\scss\main.scss */"./assets/src/scss/main.scss");
